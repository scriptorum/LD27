...
class ActionQueue
{
	...
	// Convenience adders
	public function delay(durationMS:Float): Action
	{
		return(add(new ActionDelay(durationMS)));
	}
	...
	public function setProperty(object:Dynamic, property:String, value:Dynamic): Action
	{
	...
	public function execute(): Bool 
	{
		while(first != null)
		{
			// trace("Execute " + name + ": " + first.toString());
...
class ActionDelay extends Action
{
	...
	public function new(durationMS:Float)
	{
		super();
	...
	override public function execute(): Bool
	{
		...
		return (Timestamp.now() - time) >= durationMS;
	}

	override public function toString(): String
	{
		return "ActionDelay (duration:" + durationMS + ")";
	}
}
